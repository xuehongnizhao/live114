...
@interface SpikeCodeTableViewCell ()
...
@implementation SpikeCodeTableViewCell
...
-(void)configureCell :(NSDictionary*)dic section:(NSInteger)section
{
    if (section == 0) {
...
//        _iconImage.layer.cornerRadius = 20.0f;
        ...
        _pass_word_lable.text = [NSString stringWithFormat:@"密码为：%@",dic[@"spike_code"]];
