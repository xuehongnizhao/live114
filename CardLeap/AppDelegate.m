...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.youdro.CardLeap" in the application's documents directory.
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CardLeap" withExtension:@"momd"];
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CardLeap.sqlite"];
//    NSError *error = nil;
